  ...
  Future<void> _sendChatMessage(String message) async {
    ...
    try {
      _messages.add(ChatMessage(
          text: 'Analizando...',
          isUser:
              false)); // Muestra un mensaje temporal para indicar que la respuesta está en camino
      final response = await _chat.sendMessage(Content.text(message));
      final text = response.text ?? 'No se recibió respuesta';
      setState(() {
        _messages
            .removeLast(); // Remueve el mensaje temporal antes de agregar la respuesta real
